...
export const APTOS_NETWORK: ShelbyNetwork =
  networkEnv === "shelbynet" ? Network.SHELBYNET
  : networkEnv === "local" ? Network.LOCAL
  : Network.TESTNET;

const derivedApiBase = `https://api.${networkEnv}.shelby.xyz/shelby/v1`;
